CWE-89: Improper Neutralization of Special Elements used in an SQL Command ('SQL Injection') in Reviewdemo
========================================================================================================
...
When a user Ignores or Listens to another Blabber, Reviewdemo will create an "event description" that contains
