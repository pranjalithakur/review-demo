CWE-117: Improper Output Neutralization for Logs in Reviewdemo
============================================================

Reviewdemo has a lot of logging statements, unfortunately it uses untrusted data
...
Exploit
-------
1. Go to /reviewdemo/login?target=%0D%0AINFO%20%20This%20has%20been%20injected
