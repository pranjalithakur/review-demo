Reviewdemo: CWE-73 External Control of File Name or Path
========================================================================================================

Reviewdemo uses untrusted data while constructing file paths.
...
-------
1. Go to /reviewdemo/profile as a logged in user
...
5. Navigate to /reviewdemo/resources/bin/exploit.html
