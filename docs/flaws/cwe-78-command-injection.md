CWE-78: Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection') in Reviewdemo
==============================================================================================================

Reviewdemo has a page called **Tools**, available at `/reviewdemo/tools`.
...
* https://downloads.reviewdemo.com/securityscan/cwe/v4/java/78.html#example